...
python main.py --global_model 'chavinlo/alpaca-native'\
      --data_path  "./data" \
      --output_dir  './lora-shepherd-7b-all-r8-4cli-fedsira/'\
      --device_map 'auto' \
...
python main.py --global_model 'chavinlo/alpaca-native'\
      --data_path  "./data" \
      --output_dir  './lora-shepherd-7b-q-r8-4cli-fedsira/'\
      --device_map 'auto' \
      --num_communication_rounds 20 \
      --num_clients  4 \
      --client_selection_frac 1.0 \
...
python main.py --global_model 'chavinlo/alpaca-native'\
      --data_path  "./data" \
      --output_dir  './lora-shepherd-7b-k-r8-4cli-fedsira/'\
      --device_map 'auto' \
      --num_communication_rounds 20 \
      --num_clients  4 \
      --client_selection_frac 1.0 \
...
python main.py --global_model 'chavinlo/alpaca-native'\
      --data_path  "./data" \
      --output_dir  './lora-shepherd-7b-v-r8-4cli-fedsira/'\
      --device_map 'auto' \
      --num_communication_rounds 20 \
      --num_clients  4 \
      --client_selection_frac 1.0 \
...
python main.py --global_model 'chavinlo/alpaca-native'\
      --data_path  "./data" \
      --output_dir  './lora-shepherd-7b-o-r8-4cli-fedsira/'\
      --device_map 'auto' \
      --num_communication_rounds 20 \
      --num_clients  4 \
      --client_selection_frac 1.0 \
